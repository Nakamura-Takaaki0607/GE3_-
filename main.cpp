...
#pragma endregion
    ...
    while (true) {
        ...
        if (input_->TriggerKey(DIK_D) || input_->TriggerKey(DIK_A))
        {
            if (input_->TriggerKey(DIK_D)) { angle += XMConvertToRadians(1.0f); }
            else if (input_->TriggerKey(DIK_A)) { angle -= XMConvertToRadians(1.0f); }
